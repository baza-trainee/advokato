		...
		<SectionStyled>
			<Container>
				...
				<CardWraper>
					...
					<Text>
						Адвокатська компанія {`"Статус"`} пропонує найвищий рівень юридичних послуг і
						консультацій для наших клієнтів. Ми горді надавати широкий спектр юридичних послуг,
						спеціалізовані наші адвокати і завжди готові допомогти вам у вирішенні вашого правового
						питання.
					</Text>
					<Column
						width="500px"
